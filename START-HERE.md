# Start here — MiniCPM News Desk 0.6.1
...
2. Try `python3.14 -m newsdesk demo --out outputs/first-demo` from this folder.
   Open the generated index.html. No model, network or credentials are needed.
3. Run `python3.14 -m unittest discover -s tests -v` — 110 tests.
...
5. Read EVALUATION.md before connecting your own authenticated local model.
